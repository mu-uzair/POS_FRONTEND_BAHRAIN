...
// // utils/https.js - Production-ready API endpoints with smart request wrapper
// import axios from "axios";
...
// // utils/https/index.js - COMPLETE API file with fail-fast interceptor
// import axios from "axios";
// import { withSmartRequest, OfflineError, NetworkError, TimeoutError, isSystemOffline } from "../utils/smartRequest";
// import { enqueueSnackbar } from 'notistack';
...
// // ============================================
// // REQUEST INTERCEPTOR - FAIL-FAST GUARD
// // ============================================

// api.interceptors.request.use(
//     (config) => {
//         // 🛑 CRITICAL: Block request if system is offline
//         if (isSystemOffline()) {
//             console.warn(`🚫 [INTERCEPTOR BLOCK] ${config.method?.toUpperCase()} ${config.url}`);
//             return Promise.reject(new OfflineError("App is in offline mode. Request cancelled."));
//         }
...
//     },
//     (error) => {
//         // Skip error handling for OfflineError (already handled)
//         if (error instanceof OfflineError || error.isOfflineError) {
//             return Promise.reject(error);
//         }
...
//             console.warn(`🚫 [INTERCEPTOR] BLOCKED ${method} ${url} - System offline`);
...
// import axios from "axios";
// import { withSmartRequest, OfflineError, NetworkError, TimeoutError } from "../utils/smartRequest";
// import { getOfflineState } from "../utils/offlineState"; // 👈 USE THIS INSTEAD
// import { enqueueSnackbar } from 'notistack';
...
//     (config) => {
//         // 🛑 CRITICAL: Block ALL requests if system is offline
//         const { isOffline } = getOfflineState(); // 👈 CORRECT WAY
