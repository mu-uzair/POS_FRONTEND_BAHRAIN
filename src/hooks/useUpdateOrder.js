// // hooks/useUpdateOrder.js - FIXED VERSION
...
// import { updateOrderStatusInCache, addToPendingSync } from '../utils/offlineStore';
...
//         // ✅ STEP 1: Update in cache
//         await updateOrderStatusInCache(orderId, newStatus);

//         // ✅ STEP 2: Add to pending sync queue
...
//       } else {
//         // ============================================
//         // ONLINE MODE - Update immediately (NO CACHE)
//         // ============================================
//         console.log(`🟢 [ONLINE UPDATE] Updating order ${orderId} -> ${newStatus}`);

//         // ✅ ONLY call API - do NOT modify offline cache or pendingSync
//         await updateOrderStatusAPI({ orderId, orderStatus: newStatus });

//         // ✅ Invalidate React Query cache (will refetch from server)
...
// ============================================
// SOLUTION 1: Update useUpdateOrder.js
// ============================================
// hooks/useUpdateOrder.js - COMPLETE FIXED VERSION
