// // src/components/shared/OfflineToggleButton.jsx
...
//       className={`px-3 sm:px-4 py-2 rounded-lg font-medium text-xs sm:text-sm transition-all flex items-center gap-2 ${
//         manualOfflineMode
//           ? "bg-green-600 hover:bg-green-700 text-white"
//           : "bg-[#333333] hover:bg-[#444444] text-[#f5f5f5]"
...
// export default OfflineToggleButton;
  ...
  // components/OfflineIndicator.jsx - Production-ready offline status indicator
