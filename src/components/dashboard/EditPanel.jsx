...
//   updateTableData,
//   deleteTable,
// } from "../../https"; // CORRECTED: Changed '../https' to './https' 
// import { enqueueSnackbar } from "notistack";
...
//       if (i === variationIndex) {
//         // Convert the input value (in dollars) to an integer (in cents) for storage in the edits state
//         const priceInCents = Math.round(parseFloat(newValueInDollars) * 100);
//         return { ...v, price: isNaN(priceInCents) ? 0 : priceInCents };
//       }
//       return v;
//     });
...
//       // Note: Variations prices are already converted to cents in handleEditVariationPrice
//     }
...
//                             const priceInDollars = (Math.max(0, priceInCents) / 100).toFixed(2);
