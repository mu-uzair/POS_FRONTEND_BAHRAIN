...
const Greetings = () => {
  ...
  return (
    <div className='flex justify-between items-center px-8 mt-5'>
        <div >
            <h1 className='text-[#f5f5f5] text-2xl font-semibold tracking-wide mb-2'>Good Morning, {userData.name || "Guest"}</h1>
            <p className='text-[#ababab] text-sm'>Give your best services for customer❤️</p>
        </div>
        <div>
