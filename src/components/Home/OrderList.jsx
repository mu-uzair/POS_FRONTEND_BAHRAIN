...
const OrderList = ({ order }) => {
  ...
  const {
    ...
    table = { tableNo: null },
    orderStatus = 'Unknown',
    orderType, // Get orderType from root level (passed from RecentOrder)
  } = order || {};

  // Get the actual orderType - check multiple locations
  const actualOrderType = orderType || customerDetails?.orderType || 'Delivery';

//   console.log('🎯 OrderList - Order Type:', actualOrderType, 'Table:', table);
  ...
  return (
    <div className="flex items-center gap-5 mb-5">
        ...
        <div className="flex items-center justify-between w-[100%]">
            ...
            <div>
                {/* Conditionally render based on table existence and orderType */}
                {table?.tableNo ? (
